...
The research question asked in a rather general manner, whether authoring tools can benefit from version control. The thesis at hand tried to answer this question by documenting the user-centered design approach used for designing such a system. The design presented above shows that it is indeed possible to unify a content authoring tool with a version control system, but the question remains, whether this liaison is beneficial to the tool's users? By looking at the research questions posed in the beginning, we might be able to come closer to an answer.
