...
The next two chapters, Chapter \ref{chapter:version-control} and \ref{chapter:methods},  introduce the reader to version control software in more detail as well as the methodology used throughout the research project.

Chapter \ref{chapter:related-work} introduces the reader to relevant research in adjacent fields. This is followed by a more in-depth description of the different user groups at Babbel, their requirements and the tasks that constitute the content authoring process (Chapter \ref{chapter:user-research}).
