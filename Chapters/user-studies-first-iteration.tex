...
% FOCUS - AIM Why is this important to overall research?
...
% OVERVIEW
Below, the design of the study is described in more detail. In total, five users participated, each of which went through three different scenarios. The scenarios were designed in a way that users had to utilize the most important features of the interface in order to reach their goals. During the sessions  participants were encouraged to speak out loud and interference by the moderator was kept to a minimum. In addition to the observations, several metrics were recorded, which helped interpret the results.
