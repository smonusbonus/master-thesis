...
Now that the concept of version control might be a little clearer, the next chapter will be about related work and the usability of version control systems in particular.
